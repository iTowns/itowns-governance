...
- At any point in time, the PSC can emit a veto for a proposal or a Pull Request. This veto must be motivated and its rationale explained in detail, with references to the project's values and global strategy and purpose.
...
The PSC is composed of legal persons and individuals according to the following two cases:
Legal person: represents an organization that have at least one core contributor. A single organization may have up to two representatives on the PSC. 
Individual: a core contributor not affiliated with a PSC member organization.  
